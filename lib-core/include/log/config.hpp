#ifndef PLIB_CORE_LOG_CONFIG_HPP
#define PLIB_CORE_LOG_CONFIG_HPP
#include <string>
#include <sstream>
...
struct LogConfig
{
  std::string appName = "plib-core";  // app name, used as log file name
...
#endif // PLIB_CORE_LOG_CONFIG_HPP